...
class SOR_Opfor_Commander_VDV : SOR_OPFor_Base_VDV
{
	...
	weapons[] = {"160_rhs_weap_ak74m_pkas","rhs_weap_makarov_pmm","Throw","Put","Laserdesignator_02"};
	respawnWeapons[] = {"160_rhs_weap_ak74m_pkas","rhs_weap_makarov_pmm","Throw","Put","Laserdesignator_02"};
...
class SOR_OPFor_RTO_VDV : SOR_OpFor_Actual_VDV
{
	...
	weapons[] = {"rhs_weap_ak74m_gp25_dtk","Throw","Put","Laserdesignator_02"};
	respawnWeapons[] = {"rhs_weap_ak74m_gp25_dtk","Throw","Put","Laserdesignator_02"};
...
//Repair Team
class SOR_OPFor_Engineer_VDV : SOR_OPFor_Base_VDV
{
